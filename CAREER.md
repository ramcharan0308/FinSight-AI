...
> Architected and engineered **FinSight AI**, a production-grade personal finance and expense intelligence platform using Next.js 14 App Router, Express, TypeScript, Prisma ORM, and PostgreSQL. Implemented a secure full-stack analytics platform with transaction management, budget tracking, and integrated **Groq AI** (Llama-3.3-70b) to deliver automated financial summaries and an interactive AI chat assistant, with a ChatGPT-style collapsible sidebar and fully responsive mobile design.

---

## 2. GitHub Repository Description (Under 200 Characters)
> 💡 AI-Powered Personal Finance & Expense Intelligence Platform. Built with Next.js 14, Express, TypeScript, Prisma, PostgreSQL, and Groq AI (Llama-3.3-70b).
...
> 
> Designed and deployed a complete, secure enterprise-grade expense tracking and financial intelligence platform. FinSight AI merges traditional financial ledgers with advanced AI reasoning agents to provide users with proactive savings recommendations, budget alerts, and category analytics.
> 
...
> 
> **Technologies Used:** TypeScript, Node.js, Express, Next.js 14, React, Tailwind CSS, Recharts, Prisma ORM, PostgreSQL, Docker, OpenAPI/Swagger, **Groq API** (Llama-3.3-70b), TanStack React Query v5, Zustand.
...
* **Databases & ORMs:** PostgreSQL, Prisma ORM, Database Indexing, Schema Normalization
...
* **DevOps & Infrastructure:** Docker, Docker Compose, Port Forwarding, WSL2, Local Development Environment
