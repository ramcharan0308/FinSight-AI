...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950/40 selection:bg-emerald-500/25 selection:text-emerald-900 transition-colors duration-300 lg:grid lg:grid-cols-[44%_56%]">
      ...
      <div className="flex min-h-screen flex-col justify-center px-6 py-12 sm:px-10 lg:px-14 xl:px-16 bg-white dark:bg-slate-900 border-r border-slate-200/50 dark:border-slate-800/50 shadow-xl shadow-slate-200/10 dark:shadow-none animate-fadeIn">
        <div className="w-full">
          ...
          <div className="mb-9 flex items-center gap-3 group select-none">
            <div className="flex h-11 w-11 items-center justify-center rounded-2xl bg-gradient-to-tr from-emerald-500 via-emerald-400 to-teal-400 text-white shadow-md shadow-emerald-500/20 group-hover:scale-105 transition-all duration-300">
            ...
            <div>
              ...
              <p className="mt-0.5 text-[10px] font-bold uppercase tracking-widest leading-none text-emerald-500">
                WEALTH ENGINE
              </p>
            </div>
          </div>
      ...
      <div className="hidden lg:flex relative bg-slate-950 overflow-hidden flex-col">
        ...
        {/* Gradient mesh */}
        <div className="absolute inset-0 bg-gradient-to-tr from-slate-950 via-slate-950 to-emerald-950/40" />

        {/* Ambient glows */}
        <div className="absolute top-1/3 right-1/3 w-[420px] h-[420px] rounded-full bg-emerald-500/6 blur-[100px] pointer-events-none" />
        <div className="absolute bottom-1/4 left-1/4 w-[320px] h-[320px] rounded-full bg-teal-500/5 blur-[80px] pointer-events-none" />

        {/* Content */}
        <div className="relative z-10 flex flex-col justify-between h-full p-12 xl:p-16">
          {/* Top badge */}
          <div>
            <span className="inline-flex items-center gap-1.5 rounded-full border border-emerald-400/20 bg-emerald-400/10 px-3 py-1 text-xs font-semibold text-emerald-400 backdrop-blur-sm select-none">
